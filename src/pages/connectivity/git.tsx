...
function RepositoryComponent({ repo }: { repo: GitRepositoryConfig | null }) {
  const [modifiedData, setModifiedData] = useState<GitRepositoryConfig | null>(
    null,
  );
  const [createRepoMutation, createRepoMutationStatus] =
    useCreateGitRepositoryMutation();
  const [updateRepoMutation, updateRepoMutationStatus] =
    useUpdateGitRepositoryMutation();
  const [deleteRepoMutation, deleteRepoMutationStatus] =
    useDeleteGitRepositoryMutation();
